...
/**
 * Shameless copy of CommandSpec to provide the same functionality with
 * translation lookup for command descriptions and (maybe) suggestions
 */
public class LocalizedCommandSpec implements CommandCallable {
    ...
    LocalizedCommandSpec(CommandElement args, CommandExecutor executor, @Nullable String description, @Nullable String extendedDescription, @Nullable String permission, InputTokenizer parser) {
        this.args = args;
     ...
     */
    public static LocalizedCommandSpec.Builder builder() {
        return new LocalizedCommandSpec.Builder();
    }
    ...
    public static final class Builder {
         ...
         * @return this
         */
        public LocalizedCommandSpec.Builder permission(String permission) {
            this.permission = permission;
            return this;
        }
         ...
         * @return this
         */
        public LocalizedCommandSpec.Builder executor(CommandExecutor executor) {
         ...
         * @return this
         */
        public LocalizedCommandSpec.Builder children(Map<List<String>, ? extends CommandCallable> children) {
         ...
         * @return this
         */
        public LocalizedCommandSpec.Builder child(CommandCallable child, String... aliases) {
            if (this.childCommandMap == null) {
                this.childCommandMap = new HashMap<>();
            }
         ...
         * @return this
         */
        public LocalizedCommandSpec.Builder child(CommandCallable child, Collection<String> aliases) {
            if (this.childCommandMap == null) {
                this.childCommandMap = new HashMap<>();
            }
            this.childCommandMap.put(ImmutableList.copyOf(aliases), child);
        ...
        /**
         * Path of a short, one-line description of this command's purpose.
         *
         * @param description The description to set
         * @return this
         */
        public LocalizedCommandSpec.Builder description(@Nullable String description) {
            this.description = description;
            return this;
        }

        /**
         * Sets the path to an extended description to use in longer help listings for this
         ...
         * @return this
         */
        public LocalizedCommandSpec.Builder extendedDescription(@Nullable String extendedDescription) {
         ...
         * @return this
         */
        public LocalizedCommandSpec.Builder childArgumentParseExceptionFallback(boolean childCommandFallback) {
         ...
         * @return this
         */
        public LocalizedCommandSpec.Builder arguments(CommandElement args) {
         ...
         * @return this
         */
        public LocalizedCommandSpec.Builder inputTokenizer(InputTokenizer parser) {
         ...
         * @return the new spec
         */
        public LocalizedCommandSpec build() {
            ...
            return new LocalizedCommandSpec(this.args, this.executor, this.description, this.extendedDescription, this.permission,
                    this.argumentParser);
        }
    ...
    public Optional<Text> getShortDescription(CommandSource source) {
        return this.description.map(path->WarCraft.T().localText(path).orLiteral(source));
    }
    ...
    public Optional<Text> getExtendedDescription(CommandSource source) {
        return this.extendedDescription.map(path->WarCraft.T().localText(path).orLiteral(source));
    }
    ...
    public boolean equals(@Nullable Object o) {
        ...
        LocalizedCommandSpec that = (LocalizedCommandSpec) o;
        return com.google.common.base.Objects.equal(this.args, that.args)
                && com.google.common.base.Objects.equal(this.executor, that.executor)
                && com.google.common.base.Objects.equal(this.description, that.description)
                && com.google.common.base.Objects.equal(this.extendedDescription, that.extendedDescription)
                && com.google.common.base.Objects.equal(this.permission, that.permission)
                && com.google.common.base.Objects.equal(this.argumentParser, that.argumentParser);
    }

    @Override
    public int hashCode() {
        return com.google.common.base.Objects.hashCode(this.args, this.executor, this.description, this.extendedDescription, this.permission, this.argumentParser);
    }
