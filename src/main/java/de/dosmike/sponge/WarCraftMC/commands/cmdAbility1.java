...
public class cmdAbility1 implements CommandExecutor {
	...
	public static PermissionRegistry.Permission permission = PermissionRegistry.register("ability1", "wc.race.ability1", Text.of("Allow access to /ability1"), PermissionDescription.ROLE_USER);
	public static LocalizedCommandSpec getCommandSpec() {
		return LocalizedCommandSpec.builder()
			.description("commands.ability1.description")
