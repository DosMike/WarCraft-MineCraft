...
public class PermissionRegistry {
    ...
    public static class Permission {
        ...
        public Permission(String id, @Nullable Text description, @Nullable @MagicConstant(valuesFromClass = PermissionDescription.class) String group) {
            if (id == null)
            ...
            WarCraft.describePermission().ifPresent(perm -> {
                perm.id(id);
        ...
        public void test(CommandSource src) throws CommandException {
            if (!src.hasPermission(id))
                throw new CommandPermissionException(WarCraft.T()
                        .localText("permission.denied")
